...
import { IconCheck as Check, IconMagnifier as Search } from "nucleo-micro-bold";
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        className={cn(
          "flex h-11 w-full rounded-md bg-transparent py-3 text-base md:text-sm outline-hidden text-foreground placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        {...props}
      />
